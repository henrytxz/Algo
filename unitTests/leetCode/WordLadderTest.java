...
public class WordLadderTest {
    ...
    public void testLadderLength() throws Exception {
        ...
        int l = WordLadder.ladderLength(start, end, dict);
        System.out.println("word ladder length:"+l);
        ...
        change searching the dict to flipping characters in the word in hand
        reduces execution time from 12ms to 7ms
        */
    }
}